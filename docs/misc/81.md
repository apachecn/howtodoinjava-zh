...
1.  可重用 2.3.1.GA
2.  RESTEasy Jettison 提供程序 2.3.1
3.  雄猫 7
4.  JDK 1.6
...
当我们在 tomcat 中部署上述构建的应用程序并单击 URL：`"http://localhost:8080/RESTfulDemoApplication/user-management/users/10"`时，以下是响应。

<figure aria-describedby="caption-attachment-1977" class="wp-caption alignnone" id="attachment_1977" style="width: 949px">![RESTEasy + Jettison example](img/f497f470331bb5e3d63a6bc02ae77fc6.png)

<figcaption class="wp-caption-text" id="caption-attachment-1977">RESTEasy + Jettison example</figcaption>

</figure>

学习愉快！

[Sourcecode Download](https://github.com/lokeshgupta1981/RESTEasy/tree/master/RESTfulDemoApplication)