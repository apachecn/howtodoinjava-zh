...
本教程说明**如何在 Jersey 2.x** 中使用 MOXy JSON 功能。 MOXy 是 Jersey 2.x 中的**默认 JSON 绑定供应器。 尽管由于性能原因，我个人还是更喜欢 **[Jackson，而不是 MOXy](http://jersey.576304.n2.nabble.com/Jackson-vs-MOXy-td7581625.html)** 。**
