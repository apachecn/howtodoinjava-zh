...
根据 Wikipedia 的定义， [**延迟加载**](https://en.wikipedia.org/wiki/Lazy_loading "lazy loading") 是一种设计模式，通常用于计算机编程中，以将对象的初始化推迟到需要的时间点。 我们知道，在休眠映射中，可以通过在休眠映射注释中指定**“ fetch = FetchType.LAZY”** 来完成延迟加载。 例如
