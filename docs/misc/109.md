...
<figure aria-describedby="caption-attachment-5019" class="wp-caption aligncenter" id="attachment_5019" style="width: 954px">![Jersey authentication failure request](img/f42fb309b8785bfa4c6f66eaea7edb5e.png)

<figcaption class="wp-caption-text" id="caption-attachment-5019">Jersey authentication failure request</figcaption>

</figure>

#### 在基本身份验证参数中传递用户名和密码：howtodoinjava / password

<figure aria-describedby="caption-attachment-5021" class="wp-caption aligncenter" id="attachment_5021" style="width: 700px">![Jersey authenticated success request](img/039a521b61899a1c7a82b3108b65af1a.png)

<figcaption class="wp-caption-text" id="caption-attachment-5021">Jersey authenticated success request</figcaption>
