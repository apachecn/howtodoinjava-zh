...
<figure aria-describedby="caption-attachment-7655" class="wp-caption aligncenter" id="attachment_7655" style="width: 951px">![Dropwizard health check on admin port](img/a2702917b0cb22a2de78eb4226037ee8.png)

<figcaption class="wp-caption-text" id="caption-attachment-7655">Dropwizard health check on admin port</figcaption>

</figure>

#### 2）http：// localhost：8080 / status

<figure aria-describedby="caption-attachment-7656" class="wp-caption aligncenter" id="attachment_7656" style="width: 757px">![Dropwizard health check on application port](img/8e966d37a262cedc766088330712ba49.png)

<figcaption class="wp-caption-text" id="caption-attachment-7656">Dropwizard health check on application port</figcaption>
