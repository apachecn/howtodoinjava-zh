...
学习使用 [**JUnit**](https://howtodoinjava.com/junit-4/) 和 **Mockito** 测试框架为 Spring 应用的服务层编写 **[单元测试](https://howtodoinjava.com/best-practices/unit-testing-best-practices-junit-reference-guide/)。 本教程演示 *[弹簧启动](https://howtodoinjava.com/spring-boot-tutorials/)测试服务层示例*。**
...
**MockitoJUnitRunner** 类自动初始化所​​有带有`@Mock`和`@InjectMocks`注解的对象。
