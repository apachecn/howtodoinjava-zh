...
<figure aria-describedby="caption-attachment-12209" class="wp-caption aligncenter" id="attachment_12209" style="width: 616px">![Spring boot mockito junit example](img/9a3de840ff5166ee3ecbadd6b81e529f.png)

<figcaption class="wp-caption-text" id="caption-attachment-12209">Spring boot mockito junit example</figcaption>
