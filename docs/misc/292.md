...
学习创建一个[弹簧启动](https://howtodoinjava.com/spring-boot-tutorials/)应用，该应用能够连接给定的 [Apache Kafka](https://howtodoinjava.com/kafka/tutorial-introduction/) 代理实例。 另外，从 Kafka 主题中学习产生和消费消息。
