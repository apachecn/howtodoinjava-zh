...
<figure aria-describedby="caption-attachment-2245" class="wp-caption aligncenter" id="attachment_2245" style="width: 632px">![Valid request to REST API](img/01fae53f6f43293bfabc8b5b0284e74b.png)

<figcaption class="wp-caption-text" id="caption-attachment-2245">Valid request to REST API</figcaption>
...
<figure aria-describedby="caption-attachment-2246" class="wp-caption aligncenter" id="attachment_2246" style="width: 614px">![Invalid request to REST API](img/ed948f4c32d7282ac2517a605c1cdbb9.png)

<figcaption class="wp-caption-text" id="caption-attachment-2246">Invalid request to REST API</figcaption>
