...
#### 3.2 [结识一些题目](//howtodoinjava.com/category/puzzles/ "Puzzles")
...
#### 5.1 [针对 Oracle 企业管理器项目](https://howtodoinjava.com/interview-questions/real-java-interview-questions-asked-for-oracle-enterprise-manager-project/)的 Real Java 面试问题

到目前为止，您已经学习了 Java 中的所有不同概念，这些概念可以通过面试问题的形式出现在您面前。 现在该看看您是否准备好了。 在接受 Oracle Corporation 面试时，请回答 Sreenath Ravva 提出的一些实际问题。
