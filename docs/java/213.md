...
**Java try，catch 和最后**块有助于编写可能在运行时引发[异常](https://howtodoinjava.com/java/exception-handling/checked-vs-unchecked-exceptions-in-java/)的应用程序代码，并为我们提供了通过执行替代应用程序逻辑或[从异常中恢复的机会 优雅地处理异常](https://howtodoinjava.com/best-practices/java-exception-handling-best-practices/)，以向用户报告。 它有助于防止丑陋的应用程序崩溃。
