...
学习创建一个[SpringBoot](https://howtodoinjava.com/spring-boot-tutorials/)应用，该应用能够连接给定的 [Apache Kafka](https://howtodoinjava.com/kafka/tutorial-introduction/) 代理实例。 另外，从 Kafka 主题中学习产生和消费消息。
...
打开 [spring initializr](https://start.spring.io/) 并创建具有以下依赖项的 spring boot 应用：
