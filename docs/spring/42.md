...
4.  [使用 application.properties 的 Spring 运行日志记录](https://howtodoinjava.com/spring-boot/logging-application-properties/)
5.  [Tomcat 的 Jetty，Jetty 的&的 SpringBoot 嵌入式服务器日志配置](https://howtodoinjava.com/spring-boot2/embedded-server-logging-config/)
...
10.  [Spring 运行配置文件特定的日志记录示例](https://howtodoinjava.com/spring-boot2/profile-specific-logging/)
