...
在此示例中，我们将创建简单的 spring 应用程序，添加日志记录方面，然后基于在`@Before`注解中传递的切入点信息来调用方面方法。
...
[@注解之前](https://eclipse.org/aspectj/doc/next/aspectj5rt-api/org/aspectj/lang/annotation/Before.html)
