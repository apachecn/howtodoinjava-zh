...
**`<context:component-scan>` = Bean 注册 + 扫描并激活注释**
...
1.  使用 **JSR-303 注释**和任何参考实现，例如 **Hibernate 验证器**
...
> **阅读更多：Spring MVC [自定义验证器](//howtodoinjava.com/spring/spring-mvc/spring-mvc-custom-validator-example/)和 [JSR-303 批注](//howtodoinjava.com/spring/spring-mvc/spring-bean-validation-example-with-jsr-303-annotations/)示例**
