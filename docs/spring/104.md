...
*   **测试 Consul 服务器是否正在运行** – Consul 在默认端口上运行，并且代理成功启动后，浏览 [http://localhost:8500/ui](http://localhost:8500/ui)，您应该会看到一个 控制台屏幕如：
...
*   打开浏览器并使用 URL [http://localhost:8098//getSchoolDetails/abcschool](http://localhost:8098//getSchoolDetails/abcschool) 测试学校 REST 服务。 它将给出以下响应，并将使用 Consul 服务在内部调用学生服务。
...
[下载源码](//howtodoinjava.com/wp-content/uploads/2017/07/Consoul.zip)
