...
在[Spring 自动接线](https://howtodoinjava.com/spring-core/spring-beans-autowiring-concepts/)中，`@Autowired`注解仅处理接线部分。 我们仍然必须定义 bean，以便容器知道它们并可以为我们注入它们。
...
[@存储库注解](https://docs.spring.io/spring/docs/current/javadoc-api/org/springframework/stereotype/Repository.html)
[@服务注解](https://docs.spring.io/spring/docs/current/javadoc-api/org/springframework/stereotype/Service.html)
