...
这篇文章是我以前关于 [**spring mvc 验证（使用 JSR-303 批注**](//howtodoinjava.com/spring/spring-mvc/spring-bean-validation-example-with-jsr-303-annotations/) ）的继续。 我将修改相同的源代码。
...
[**Sourcecode Download**](https://drive.google.com/file/d/0B7yo2HclmjI4NE9ILW1GNDBCUGM/view?usp=sharing)
